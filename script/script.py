...
TESTCASE OPERATION
"""
class OrganizationPackages:
    """
    This testcase is to create organization named packages, which will consist of runner from repo level, org leve, and ent level.
    """
    def run(self, driver, url, version, verify_data):
        checkpoint('STARTING PACKAGES OPERATION')
        if verify_data == False:
            driver.get(f'{url}/organizations/new')
            driver.find_element(By.CSS_SELECTOR, '.form-control.js-new-organization-name.width-full.py-1').send_keys('packages')
            time.sleep(3)
            try:
                driver.find_element(By.CSS_SELECTOR,'.form-control.js-new-organization-name.width-full.py-1.is-autocheck-errored')
                print('org packages already exist')
                op_message = f'organization \'packages\' already existed - {is_pass}'
            except:
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                time.sleep(3)
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                print('Organization packages created. please create runner manually')
                op_message = f'Org \'packages\' created. Please create runner manually.'
            operation = True
        else:
            operation = False
        ...
        checkpoint('OPERATION PACKAGES COMPLETED')
        
        checkpoint("VERIFYING ORGANIZATIONPACKAGES DATA")
        driver.get(f'{url}/packages')
        print('')
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'Organization packages not found')
            verify_status = False
        except:
            verify_status = True
        ...
        if verify_status == True:
            ...
            verify_message = f'{__class__.__name__} Data - {is_incomplete}. \n  Org \'packages\' not found. - {is_fail}'

        checkpoint("ORGANIZATION DATA VERIFICATION COMPLETED")
        return version, operation_message, verify_message
    
class OrganizationPackages2:
    """
    This testcase is to create organization named packages2 which used for instance validation.
    """
    def run(self, driver, url, version, verify_data):
        checkpoint('STARTING PACKAGES OPERATION')
        if verify_data == False:
            driver.get(f'{url}/organizations/new')
            driver.find_element(By.CSS_SELECTOR, '.form-control.js-new-organization-name.width-full.py-1').send_keys('packages2')
            time.sleep(3)
            try:
                driver.find_element(By.CSS_SELECTOR,'.form-control.js-new-organization-name.width-full.py-1.is-autocheck-errored')
                print('org packages2 already exist')
                op_message = f'organization \'packages2\' already existed - {is_pass}'
            except:
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                time.sleep(3)
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                print('Organization packages2 created. please create runner manually')
                op_message = f'Org \'packages2\' created. Please create runner manually.'
            operation = True
        else:
            operation = False
        ...
        if operation:
            ...
            operation_message = f'{__class__.__name__} Data - {is_skip}'
        checkpoint('OPERATION PACKAGES2 COMPLETED')
        
        checkpoint("VERIFYING ORGANIZATIONPACKAGES DATA")
        driver.get(f'{url}/packages2')
        print('')
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'Organization packages2 not found')
            verify_status = False
        except:
            verify_status = True
        ...
        if verify_status == True:
            ...
            verify_message = f'{__class__.__name__} Data - {is_incomplete}. \n  Org \'packages2\' not found. - {is_fail}'
...
class RepoPackage: 
    def run(self, driver, url, version, verify_data):
        try:
            driver.get(f'{url}/orgs/packages/')
            time.sleep(3)
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'Organization packages not found')
            org_status = False
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                driver.get(f'{url}/organizations/packages/repositories/new')
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    print('repo v3.11')
                    repo_name_field = driver.find_element(By.CLASS_NAME, 'UnstyledTextInput-sc-14ypya-0.cDLBls').send_keys('package')
                    time.sleep(2)
                    try: 
                        driver.find_element(By.CSS_SELECTOR,'.Text-sc-17v1xeu-0.itFImB')
                        print('package repo already exist lorhh')
                        op_message1 = f'repo \'package\' already existed - {is_pass}'
                        driver.get(f'{url}/packages/package')
                    except:
                        ...
                        if version in v.version_list_3_12:
                            ...
                            print('Repo package created.')
                        time.sleep(4)
                        op_message1 = f'Created repo \'package\' - {is_pass}'
                else:
                    driver.get(f'{url}/organizations/packages/repositories/new')
                    driver.find_element(By.ID,'repository_name').send_keys('package')
                    time.sleep(2)
                    try:
                        driver.find_element(By.CSS_SELECTOR,'.form-control.js-repo-name.js-repo-name-auto-check.short.is-autocheck-errored')
                        print('repo package already exist')
                        op_message1 = f'repo \'package\' already existed - {is_pass}'
                    except:
                        if version in v.version_list_3_11 or version in v.version_list_3_12:
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.bzxfWd').click()
                        ...
                        print('Repo package created.')
                        op_message1 = f'repo \'package\' created'
                        time.sleep(3)
            ...
            if operation:
                ...
                operation_message = f'{__class__.__name__} Data - {is_skip}'
            checkpoint('OPERATION REPO PACKAGE COMPLETED')
        ...
        # elif verify_status == False:
        #     verify_message = f'{__class__.__name__} Data -  {is_incomplete}. Org \'packages\' not found. Please create first.'

        checkpoint(f"{__class__.__name__} DATA VERIFICATION COMPLETED")
        return version, operation_message, verify_message

class RepoPages: #enitity
    def run(self, driver, url, version, verify_data): #def run = action, arguement = self, driver, url, version, verify_data
        checkpoint(f'STARTING {__class__.__name__} OPERATION')
        driver.get(f'{url}/basic-data')
        time.sleep(3)
        try:
            driver.get(f'{url}/basic-data/data/settings/pages')
            time.sleep(3)
            #select branch
            driver.find_element(By.CSS_SELECTOR, ".details-reset.details-overlay.d-inline-block .css-truncate-target").click()
            print(f'Branches found')
            op_message = f'Branch selected - {is_pass}'
            op = True
        except:
        ...
        if op:
            if verify_data == False:
                # driver.get(f'{url}/basic-data/data/settings/pages')
                time.sleep(3)
                driver.find_element(By.CSS_SELECTOR,'.SelectMenu-item.text-normal')
                parent = driver.find_elements(By.CSS_SELECTOR,'.SelectMenu-item.text-normal')
                # parent = [.SelectMenu-item.text-normal - main,
                #           .SelectMenu-item.text-normal - branch1,
                #           .SelectMenu-item.text-normal - branch2]
                for elem in parent:
                    print(elem.text) 
                    if elem.text == 'sample-branch-2':
                        elem.click()
                        print('branch found and selected')
                        break
                else:
                    print('not found')
                ...
                # driver.get(f'{url}/basic-data/data/settings/pages')
                #select branch
                driver.find_element(By.CSS_SELECTOR, ".js-jekyll-submit.btn.ml-1").click()
                print(f'Repo Pages Saved')
                time.sleep(3)
                driver.get(f'{url}/basic-data/data/settings/pages')
                time.sleep(3)
                op_message = f'RepoPages data created - {is_pass}'
                operation = True
            else:
                operation = False        
            ...
            operation_message = f'{__class__.__name__} Data - {is_incomplete}. Org \'basic-data\' not found. Please create first.' 
        ...
        try:
            #visit site
            vsite = driver.find_element(By.CSS_SELECTOR, '.flex-self-start.btn')
            vsite.click()
            print(vsite.text)
            time.sleep(3)
            print(f'RepoPages found')
            verify_status = True
            op_message = f'Repo \'pages\' found. Well done - {is_pass}'
        except:
            verify_status = False
            print(f'RepoPages not found!')
            op_message = f'Repo \'pages\' not found. Please recreate the Pages - {is_fail}'
        ...
        checkpoint("RepoPages DATA VERIFICATION COMPLETED")
        return version, operation_message, verify_message #return data
...
class OrganizationBasicData:
    def run(self, driver, url, version, verify_data):
        ...
        if verify_data == False:
            driver.get(f'{url}/organizations/new')
            driver.find_element(By.CSS_SELECTOR, '.form-control.js-new-organization-name.width-full.py-1').send_keys('basic-data')
            driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
            time.sleep(3)
            driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
            print("Create Organization basic-data")
        ...
        checkpoint("VERIFYING ORGANIZATION BASIC-DATA DATA")
        driver.get(f'{url}/basic-data')
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'Organization basic-data not found')
            verify_status = False
        except:
            verify_status = True

        if verify_status:
            verify_message = f'{__class__.__name__} Data - {is_complete}. \n  Org \'basic-data\' found - {is_pass}'
        else:
            verify_message = f'{__class__.__name__} Data - {is_fail}. Org \'basic-data\' not found.'

        checkpoint("ORGANIZATION BASIC-DATA DATA VERIFICATION COMPLETED")
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                driver.get(f'{url}/organizations/basic-data/repositories/new')
                time.sleep(3)
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    print('repo v3.11')
                    ...
                    try: 
                        ...
                        try:
                            ...
                            time.sleep(2)
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.dqTQGQ').click()
                        ...
                        if version in v.version_list_3_12:
                            try:
                                ...
                                driver.find_element(By.CSS_SELECTOR,'.types__StyledButton-sc-ws60qy-0.gariCr').click()
                                print('instance is in Dark Mode')
                            ...
                            try:
                                ...
                                create_repo = driver.find_element(By.CLASS_NAME,'types__StyledButton-sc-ws60qy-0.iqZIXT').click()
                                print('instance is in Dark Mode')
            ...
            verify_message = f'Verification {__class__.__name__} Data - {is_incomplete}. Org \'basic-data\' not found. Please create first.' 
            operation_message = f'Operation {__class__.__name__} Data - {is_incomplete}. Org \'basic-data\' not found. Please create first.' 
        return version, operation_message, verify_message
...
class SampleBranch:
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_status:
                ...
                if verify_data == False: 
                    ...
                    for i in range(2):
                        ...
                        #sample file
                        driver.get(f'{url}/basic-data/data/tree/sample-branch-{i+1}')
                        time.sleep(2)
                ...
                try:
                    ...
                    print('branch list found')
                except:
                    driver.find_element(By.CSS_SELECTOR,'.btn.css-truncate').click()
                    print('reclick button list')
                time.sleep(3)
                sample_branch = ['sample-branch-1','sample-branch-2']
                br_message_ls = []
            ...
            verify_message = f'{__class__.__name__} Data - {is_incomplete}. Org \'basic-data\' not found. Please create first.' 
            operation_message = f'{__class__.__name__} Data - {is_incomplete}. Org \'basic-data\' not found. Please create first.' 
        ...
        if org_status:
            ...
            if verify_status:
                ...
                if verify_data == False: 
                    #closed pr
                    print('close PR')
                    driver.get(f'{url}/basic-data/data/compare')
                    time.sleep(2)
                    ...
                    for elem in pr_btn:
                        ...
                        if 'compare' in elem.text:
                            ...
                            try:
                                driver.find_element(By.CSS_SELECTOR,'.flex-1.css-truncate.css-truncate-overflow')
                                print('check branch list')
                            except:
                                elem.click()
                                print('recheck branch list')
                            # branch_list = driver.find_elements(By.CLASS_NAME,'SelectMenu-item')
                            branch_list = driver.find_elements(By.CSS_SELECTOR,'.flex-1.css-truncate.css-truncate-overflow')
                            for branch in branch_list:
                                print(branch.text)
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/pulls?q=is%3Aopen+is%3Apr')
                    time.sleep(2)
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/pulls?q=is%3Apr+is%3Aclosed')
                    time.sleep(2)
                    driver.find_element(By.CSS_SELECTOR,'.d-flex.Box-row--drag-hide.position-relative')
...
class LFSData:
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            try:
                driver.find_element(By.CLASS_NAME, 'font-mktg')
                print(f'You are in the wrong path. Please ensure you are in {url}/basic-data/data')
        ...
        if org_status:
            ...
            if verify_status:
                ...
                if verify_data == False:
                    ...
                    driver.get(f'{url}/basic-data/data/releases/new')  
                    time.sleep(2)
                ...
                #v3.7
                driver.get(f'{url}/basic-data/data/releases')
                time.sleep(2)
                try:
...
class Package:
    def run(self, driver, url, version, verify_data):
        ...
        if verify_data == False:
            ...
            if version in v.version_list_3_7:
                ...
                if version in v.version_list_3_12 or version in v.version_list_3_11:
                    driver.get(f'{url}/basic-data/data/actions/new')
                    try:
                        driver.find_element(By.CLASS_NAME, 'font-mktg')
                        ...
                        for elem in wflow:
                            try:
                                if version in v.version_list_3_11:
                                    print('3.11')
                    ...
                    driver.get(f'{url}/basic-data/data/new/main?filename=.github%2Fworkflows%2Fnpm-publish-github-packages.yml&workflow_template=ci%2Fnpm-publish-github-packages')
                    time.sleep(3)
        ...
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'You are in the wrong path. Please ensure you are in {url}/basic-data/')
            verify_status = False
        except:
            verify_status = True
        ...
        if verify_status == True:
            #workflow
            driver.get(f'{url}/basic-data/data/tree/main/.github/workflows')
            ...
            driver.get(f'{url}/basic-data/data/packages')
            pkg_list = []
            try:
        ...
        if org_status:
            ...
            if verify_status: 
                ...
                if verify_data == False:
                    category = ['Open','Close']
                    for cat in category:
                        driver.get(f'{url}/basic-data/data/issues/new')  
                        time.sleep(3)
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/issues?q=is%3Aopen+is%3Aissue')
                    time.sleep(2)
                    driver.find_element(By.CSS_SELECTOR,'.d-flex.Box-row--drag-hide.position-relative')
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/issues?q=is%3Aissue+is%3Aclosed')
                    time.sleep(2)
                    driver.find_element(By.CSS_SELECTOR,'.d-flex.Box-row--drag-hide.position-relative')
            ...
            if verify_status:
                ...
                if verify_data == False: 
                    ...
                    for cat in category:
                        ...
                        driver.get(f'{url}/basic-data/data/projects/new')  
                        time.sleep(3)
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/projects?query=is%3Aopen&type=classic')
                    time.sleep(2)
                ...
                #v3.7
                try:
                    driver.get(f'{url}/basic-data/data/projects?query=is%3Aclosed&type=classic')
                    time.sleep(2)
                    driver.find_element(By.CSS_SELECTOR,'.Box-row.clearfix.position-relative.pr-6')
            ...
            if verify_status:
                ...
                if verify_data == False:
                    ...
                    for page in range(1,3):
                        ...
                        wiki_open_page = driver.get(f'{url}/basic-data/data/wiki/_new')
                        time.sleep(1)
                ...
                #v3.7
                driver.get(f'{url}/basic-data/data/wiki')
                time.sleep(2)
                try:
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_status:
                ...
                if verify_data == False:
                    try:
                        driver.get(f'{url}/basic-data/data/settings/hooks')
                        time.sleep(2)
                        ...
                        driver.get(f'{url}/basic-data/data/settings/hooks/new')  
...
class PreReceiveHook:
    def run(self, driver, url, version, verify_data):
        ...
        if op:
            if verify_data == False:
                #NOTE upload file
                driver.get(f'{url}/basic-data/data/upload/main')
                time.sleep(3)
        ...
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'You are in the wrong path. Please ensure you are in {url}/basic-data/data')
            message = f'You are in the wrong path. Please ensure you are in {url}/basic-data/data - {is_fail}'
            print(f'Please add pre-receive hook file in this organization and repo')
...
class OrganizationSecurityAlerts:
    def run(self, driver, url, version, verify_data):
        ...
        if verify_data == False:
            driver.get(f'{url}/organizations/new')
            driver.find_element(By.CSS_SELECTOR, '.form-control.js-new-organization-name.width-full.py-1').send_keys('security-alerts')
            time.sleep(2)
            try:
                driver.find_element(By.CSS_SELECTOR,'.form-control.js-new-organization-name.width-full.py-1.is-autocheck-errored')
                print('org security-alerts already exist')
                op_message = f'organization \'security-alerts\' already existed - {is_pass}'
            except:
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                time.sleep(3)
                driver.find_element(By.CSS_SELECTOR, '.btn.btn-primary.btn-large.signup-btn.width-full').click()
                print("Create Organization security-alerts")
        ...
        checkpoint("VERIFYING ORGANIZATION SECURITY-ALERTS DATA")
        driver.get(f'{url}/security-alerts')
        try:
            driver.find_element(By.CLASS_NAME, 'font-mktg')
            print(f'Organization security-alerts not found')
            verify_status = False
        except:
            verify_status = True

        if verify_status == True:
            verify_message = f'{__class__.__name__} Data - {is_complete}. \n  Org \'security-alerts\' found - {is_pass}'
        elif verify_status == False:
            verify_message = f'{__class__.__name__} Data - {is_incomplete}. \n  Org \'security-alerts\' not found - {is_fail}'

        checkpoint("ORGANIZATION SECURITY-ALERTS DATA VERIFICATION COMPLETED")
        return version, operation_message, verify_message
...
class RepoCodeScanning:
    def run(self, driver, url, version, verify_data):
        ...
        if org_status == True:
            ...
            if verify_data == False:
                #create repo code-scanning 
                driver.get(f'{url}/organizations/security-alerts/repositories/new')
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    print('repo v3.11')
                    ...
                    try: 
                        ...
                        driver.get(f'{url}/security-alerts/code-scanning')
                    except:
                        try:
                            time.sleep(2)
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.bzxfWd').click()
                ...
                #advance setting
                driver.get(f'{url}/security-alerts/code-scanning/settings/security_analysis')
                time.sleep(3) 
                # if not v3.7 v3.8
                if version in v.version_list_3_9 or version in v.version_list_3_10 or version in v.version_list_3_11 or version in v.version_list_3_12: 
                ...
                #workflow
                if version in v.version_list_3_9 or version in v.version_list_3_10 or version in v.version_list_3_11 or version in v.version_list_3_12:
                    driver.get(f'{url}/security-alerts/code-scanning/actions/new')
                    try:
                        driver.find_element(By.CLASS_NAME, 'font-mktg')
                        print(f'Skipping workflow. Instance is in cluster')
                            ...
                            try:
                                ...
                                for i in range(3):
                                    if elemtxt.text == 'CodeQL Analysis':
                                        ...
                                        try:
                                            driver.find_element(By.CSS_SELECTOR,'.btn-primary.btn.float-right')
                                            print('codeql found')
                                            break
                                        except:
                                            continue
                                else:
                                    print('masih tak jumpa codeql')
                            except:
                                continue
                        else:
                    ...
                    driver.get(f'{url}/security-alerts/code-scanning/security/code-scanning')
                    time.sleep(2)
                    try: 
                ...
                # Wrong js file
                driver.get(f'{url}/security-alerts/code-scanning/upload/main')
                time.sleep(3)
            ...
            if verify_status == True:
                ...
                #workflow
                driver.get(f'{url}/security-alerts/code-scanning/tree/main/.github/workflows')
                file_list = driver.find_elements(By.CSS_SELECTOR,'.css-truncate.css-truncate-target.d-block.width-fit')
                if version in v.version_list_3_7:
                ...
                #runner
                driver.get(f'{url}/security-alerts/code-scanning/settings/actions/runners')
                try:
            ...
            verify_message = f'{__class__.__name__} Data - {is_incomplete}. Org \'security-alerts\' not found. Please create first.' 
            operation_message = f'{__class__.__name__} Data - {is_incomplete}. Org \'security-alerts\' not found. Please create first.'
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status == True:
            ...
            if verify_data == False:
                ...
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    ...
                    try: 
                        ...
                        driver.get(f'{url}/security-alerts/dependabot')
                    except:
                        try:
                            time.sleep(2)
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.bzxfWd').click()
                ...
                #enable dependabot
                #v3.11
                driver.get(f'{url}/security-alerts/dependabot/settings/security_analysis')
            ...
            if verify_status == True:
                ...
                #dependabot enabled
                #v3.7
                driver.get(f'{url}/security-alerts/dependabot/security')
                ...
                #dependabot alerts
                driver.get(f'{url}/security-alerts/dependabot/security/dependabot')
                #v3.11
                try:
            ...
            verify_message = f'Verification {__class__.__name__} Data - {is_incomplete}. Org \'security-alerts\' not found. Please create first.' 
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    ...
                    try: 
                        ...
                        driver.get(f'{url}/security-alerts/secret-scanning')
                    except:
                        try:
                            time.sleep(2)
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.bzxfWd').click()
                ...
                #v3.7
                driver.get(f'{url}/security-alerts/secret-scanning/settings/security_analysis') 
                time.sleep(3) 
                if version in v.version_list_3_9 or version in v.version_list_3_10 or version in v.version_list_3_11 or version in v.version_list_3_12:
                    parent_advsec = driver.find_element(By.CSS_SELECTOR, '.d-flex.flex-md-row.flex-column.flex-md-items-center.pt-3.mb-3.border-bottom.color-border-muted')
                else:
                ...
                # time.sleep(2)
                # new_pattern.click()
                driver.get(f'{url}/security-alerts/secret-scanning/settings/security_analysis/custom_patterns/new')
                time.sleep(3)
                try:
                    driver.find_element(By.CLASS_NAME, 'font-mktg')
                ...
                if create_pattern:
                    ...
                    for trial in range(4):
                        ...
                        try: #js-custom-pattern-submit-button btn-primary btn
                            ...
                            driver.refresh()
                            print('REFRESHH NAK PUBLISH PATTERNN')
            ...
            if verify_status:
                ...
                # SECRET ALERTS
                time.sleep(5)
                driver.get(f'{url}/security-alerts/secret-scanning/security/secret-scanning')
                time.sleep(2)
                try:
                ...
                message3_list = []
                if secalert:
                    driver.get(f'{url}/security-alerts/secret-scanning/security/secret-scanning/1')
                    time.sleep(3)
                    if version in v.version_list_3_12:
                        sec_alerts = driver.find_elements(By.CSS_SELECTOR,'.Link__StyledLink-sc-14289xe-0.gCQHPL')
                    else:
                        #v3.8
                        sec_alerts = driver.find_elements(By.CSS_SELECTOR,'.file-info.min-width-0.p-2.d-flex.flex-auto')
                    print('secret alert ni')
                    for elem in sec_alerts:
                        print('elemmm')
                        if version in v.version_list_3_12:
                            alert_filename = elem
                        else:
                            alert_filename = elem.find_element(By.CSS_SELECTOR,'.flex-self-center.f6.color-fg-default.text-mono.lh-condensed.py-1 a')
                        print(f'alerts yang adad: {alert_filename.text}')
            ...
            if verify_data == False:
                ...
                if version in v.version_list_3_11 or version in v.version_list_3_12:
                    ...
                    try: 
                        ...
                        driver.get(f'{url}/security-alerts/repo-runner')
                    except:
                        try:
                            time.sleep(2)
                            readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.bzxfWd').click()
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if verify_data == False:
            ...
            if invite:
                ...
                driver.get(f'{url}/basic-data/data/settings/access')
                time.sleep(2)
                try:
                ...
                if collab:
                    ...
                    time.sleep(3)
                    print('Successfully add user1 to org basic-data')
        ...
        if user_found == True:
            ...
            try:
                ...
                print(f'wrong password: {login_message.text}')
                # driver.find_element(By.ID,"login_field").send_keys('user1')
                driver.find_element(By.ID,"password").send_keys('Test1234')
                driver.find_element(By.NAME,"commit").click()
                time.sleep(3)
            ...
            try:
                ...
                print(f'Unable to login user1. {login_meesage.text}')
                ...
                print('user1 is a collaborator for org basic-data')
...
class TestEmail:
    def run(self, driver, url, version, verify_data):
        ...
        if verify_data == False:
            ...
            if op == True:
                driver.get(f'{url}/basic-data/data/issues')
                time.sleep(3)
                issue_open = driver.find_elements(By.CSS_SELECTOR,'.d-flex.Box-row--drag-hide.position-relative .flex-auto.min-width-0.p-2.pr-3.pr-md-2 .Link--primary.v-align-middle.no-underline.h4.js-navigation-open.markdown-title')
                for elem in issue_open:
