    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                if v.version_list_3_13 in version:
                    print('repo v3.11')
...
class RepoPages: #enitity
    def run(self, driver, url, version, verify_data): #def run = action, arguement = self, driver, url, version, verify_data
        ...
        time.sleep(3)
        try:
            driver.get(f'{url}/{name['OrganizationBasic']}/data/settings/pages')
            time.sleep(3)
            #select branch
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                try: 
                    ...
                    try:
                        time.sleep(2)
                        readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.dAJPko').click()
                        print('instance is in Light Mode')
                    except:
                        time.sleep(2)
                        readme_checkbox = driver.find_element(By.CLASS_NAME, 'Checkbox__StyledCheckbox-sc-1ga3qj3-0.edQBpi').click()
                        print('instance is in Dark Mode')
                    time.sleep(4)
                    try:
                        driver.find_element(By.CSS_SELECTOR,'.types__StyledButton-sc-ws60qy-0.kLvpkX').click()
                        print('instance is in Light Mode')
                    except:
                        driver.find_element(By.CSS_SELECTOR,'.types__StyledButton-sc-ws60qy-0.jUHnzz').click()
                        print('instance is in Dark Mode')
                    time.sleep(4)
            ...
            if verify_status:
                ...
                if verify_data == False: 
                    ...
                    for i in range(2):
                        ...
                        time.sleep(2)
                        try:
                            branch_new = driver.find_element(By.CSS_SELECTOR, '.Item__LiBox-sc-yeql7o-0.fxmDZb').click()
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if file_url_status == True:
            ...
            for file in file_list:
                ...
                print('ehe')
                if file.text == 'pre_receive_hooks_spec.rb':
                    print('ihi')
                    file_status = True
                    break
            else:
        ...
        if file_status == True:
            ...
            time.sleep(2)
            try:
                driver.find_element(By.CSS_SELECTOR, '.listgroup .item-name')
                print('aha')
            ...
            if hook_url_status == True: 
                driver.get(f'{url}/enterprises/github/settings/hooks')
                try:
                    driver.find_element(By.CSS_SELECTOR,'.listgroup .content strong')
                ...
                if verify_status:
                    ...
                    file_list = driver.find_elements(By.CSS_SELECTOR,'.react-directory-truncate .Link--primary')
                    for file in file_list:
                        if file.text == 'sample-prh-file.txt':
                            print("sample-prh-file existed")
                            break
                    else:
                        driver.get(f'{url}/{name['OrganizationBasic']}/data/new/main')
                        time.sleep(3)
                        driver.find_element(By.CSS_SELECTOR, '.UnstyledTextInput-sc-14ypya-0.cDLBls').send_keys('sample-prh-file.txt')
                        driver.find_element(By.CSS_SELECTOR, '.cm-content .cm-line').send_keys(f"Test pre receive hook commit")
                        driver.find_element(By.CSS_SELECTOR, '.types__StyledButton-sc-ws60qy-0.lKDHc').click()
                        driver.find_element(By.CSS_SELECTOR, '.types__StyledButton-sc-ws60qy-0.hMiVVt').click()
                        time.sleep(3)
            ...
            if verify_data == False:
                ...
                for file in file_list:
                    if file.text == 'sample.js':
                        op_message2 = f'sample.js already existed! - {is_pass}'
                        break
                    else:
                        continue
                else:
                    ...
                    time.sleep(4)
                    driver.find_element(By.CSS_SELECTOR, '.UnstyledTextInput-sc-14ypya-0.cDLBls').send_keys('sample.js')
                    driver.find_element(By.CSS_SELECTOR, '.cm-content .cm-line').send_keys("const a = 1;")
                    driver.find_element(By.CSS_SELECTOR, '.types__StyledButton-sc-ws60qy-0.lKDHc').click()
                    driver.find_element(By.CSS_SELECTOR, '.types__StyledButton-sc-ws60qy-0.hMiVVt').click()
                    time.sleep(3)
                    op_message2 = f'sample.js created! - {is_pass}'
                        ...
                        for elem in wflow:
                            try:
                                ...
                                if elemtxt.text == 'CodeQL Analysis':
                                    elem.find_element(By.CSS_SELECTOR,'.d-flex.flex-column.flex-auto.flex-justify-between .d-flex.flex-justify-between.flex-items-center.pt-2.pb-4.px-4 .btn.btn-sm').click()
                                    try:
                                        elem.find_element(By.CSS_SELECTOR,'.btn.btn-sm')
                                        break
                                    except:
                                        continue
                            except:
        ...
        if org_status == True:
            ...
            if verify_data == False:
                ...
                try: 
                    ...
                    time.sleep(2)
                    try:
                        createrepo = driver.find_element(By.CSS_SELECTOR,'.types__StyledButton-sc-ws60qy-0.kLvpkX').click()
                        print('instance is in Light Mode')
                    except:
                        createrepo = driver.find_element(By.CSS_SELECTOR,'.types__StyledButton-sc-ws60qy-0.jUHnzz').click()
                        print('instance is in Dark Mode')
                    time.sleep(4)
    ...
    def run(self, driver, url, version, verify_data):
        ...
        if org_status:
            ...
            if verify_data == False:
                ...
                try: 
                    driver.find_element(By.CSS_SELECTOR,'.Text-sc-17v1xeu-0.itFImB')
                    op_message1 = f'repo \'{name['OrganizationBasic']}\' already existed - {is_pass}'
